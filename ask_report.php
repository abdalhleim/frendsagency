...
<div class="main">
<form action="Ask_report.php" method="POST">
<b class="btn1">تقرير عن جميع المستخدمين</b>
    ...
    <button class="button" type="submit" name="submit-s">عرض الجميع</button>
 ...
 <table class="button"style="border: inset; font-size: 30px;>
  ...
  if (isset($_POST['submit-s'])) {
    ...
    if ($con->connect_error) {
        ...
        $sql = "SELECT * FROM jop_ask WHERE ASK_NAME LIKE '%" . $searchValue . "%'";
