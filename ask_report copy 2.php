...
<div class="main">
<form action="Ask_report copy 2.php" method="POST">
<b class="btn1">تقرير عن جميع المقدمين</b>
	<input class="button" type="" name="search" placeholder="ابحث عن متقدمين جامعة معينة">
 ...
 <table class="button"style="border: inset; font-size: 30px;>
  ...
  if (isset($_POST['submit-s'])) {
    ...
    if ($con->connect_error) {
        ...
        $sql = "SELECT * FROM jop_ask WHERE UNVERCITY LIKE '%" . $searchValue . "%'";
