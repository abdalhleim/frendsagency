...
<div class="main">
<form action="av_jop-m.php" method="POST">
<b class="btn1">تقرير الوظائف المتاحة</b>
...
<div>
 <table id="my_table" class="button"  style="border: inset;">
...
<form action="av_jop-m.php" method="POST">
<input class="button" type="" name="search" required placeholder="  ادخل التاريخ ">
 <button class="button" type="submit" name="delet">حذف اعلان الوظيفة بالتاريخ</button>
  <?php
...
<?php
 if (isset($_POST['delet'])) {
    ...
    if ($con->connect_error) {
        ...
        $sql = "DELETE FROM `jop_info` WHERE LAST_DAY LIKE '%" . $searchValue . "%'";
