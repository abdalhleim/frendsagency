...
<div class="maina">
   <form class="" id="b-form" action="login_admin_report.php" method="post">
   <div class="form1">
   <h2 class="form_title title" style="margin-right: 100px;">للتسجيل الدخول</h2>
                ...
                <b class="button1">ادخل الايمل <input class="form__input "required type="text"required name="ADMIN_EMAIL" placeholder=""></input></b></br>
              <b class="button1">كلمة المرور <input class="form__input "required type="PASSWORD"required name="ADMIN_PASSWORD" placeholder=""></input></b></br>
               <div class="form2">
